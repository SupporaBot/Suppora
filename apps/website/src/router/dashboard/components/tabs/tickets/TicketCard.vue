...
<template>
    <div class="w-full flex flex-col flex-wrap bg-bg-3/80 gap-2 p-2 rounded-md border-2 border-ring-3 overflow-auto">
        ...
        <div class="w-full flex gap-1.75 py-1.25">
            ...
            <div class="flex-center items-center! gap-1">
        ...
        <!-- Detail Badges -->
        <div class="w-full flex items-center flex-row gap-2 pb-0.5">

            <!-- Joined Staff -->
            <span class="w-fit bg-bg-4 rounded-xl p-1 flex items-center flex-wrap">
            ...
            <!-- Status -->
            <!-- Open -->
            <span v-if="p.ticket.status == 'open'" class="w-fit bg-bg-4 rounded-xl p-1 flex items-center flex-wrap">
            ...
            <span v-else-if="p.ticket.status == 'ongoing'"
                class="w-fit bg-bg-4 rounded-xl p-1 flex items-center flex-wrap">
